...
questions = ["which state of India is the most poorest?","what is the National Anthem of republic India?"," Which city in India is known as 'PINK CITY' ?","What is the capital of Arunachal pradesh?","Solve:5 + 5 = ?"]
options = [['A.Kashmir','B.Jharkhand','C.Bihar','D.Rajasthan','C.Bihar'],['A.Vandemataram','B.Jana gana mana','C.Ma tujhe Salam','D.Sare Jahan se accha','B.Jana gana mana'],
           ['A.Jaipur','B.Hyderabad','C.Chennai','D.Mumbai','A.Jaipur'],['A.Itanagar','B.Imphal','C.Shillong','D.Agartala','A.Itanagar'],['A.5','B.7','C.10','D.8','C.10']]  
